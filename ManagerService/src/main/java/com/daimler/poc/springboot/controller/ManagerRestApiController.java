...
import com.daimler.poc.springboot.service.ManagerService;
import com.daimler.poc.springboot.util.CustomErrorType;

@RestController
@RequestMapping("/api")
public class ManagerRestApiController {

	public static final Logger logger = LoggerFactory.getLogger(ManagerRestApiController.class);
